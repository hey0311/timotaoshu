...
export const appRouter = [
  ...
  // },
  {
    ...
    children: [
      ...
      //     title: "搜书爬取",
      //     access: ["4000"],
      //     name: "reptile-tool_book",
      //     component: () => import("@/views/reptile-tool/book.vue"),
      //   },
    ],
  },
  //   {
  ...
  //         title: "小说分类",
  //         access: ["5000"],
  //         name: "type_bookTypeList",
  //         component: () => import("@/views/type/bookTypeList.vue"),
  //       },
  //     ],
  //   },
  //   {
  ...
  //         access: ["6000"],
  //         name: "person_staff",
  //         component: () => import("@/views/Permission/staff.vue"),
  //       },
  //     ],
  //   },
  {
