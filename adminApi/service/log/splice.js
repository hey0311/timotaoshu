  ...
  return new Promise((resolve, reject) => {
    ...
    switch (logType) {
      case 1: //  adminApi访问日志   www
        ...
        basePath = path.join(
          global.__base,
          'log/adminApi/visit/adminApiUrlLog-' +
            new Date().Format('yyyy-MM-dd hh时mm分ss秒S') +
            '.log'
        )
        break
      ...
      case 3: //  adminApi报错日志   www
        ...
        basePath = path.join(
          global.__base,
          'log/adminApi/error/adminApiErrorLog-' +
            new Date().Format('yyyy-MM-dd hh时mm分ss秒S') +
            '.log'
        )
        break
