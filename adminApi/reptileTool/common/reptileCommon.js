...
let reptileCommon = [
    {
        code:"gbk",
        name:"ebay",
        baseUrl:"https://www.ebay.co.uk/sch/i.html?_from=R40&_trksid=p2380057.m570.l1313&_nkw=desk&_sacat=0",
        searchUrl:(bookName) => {  /*返回搜索地址*/
            return "https://www.ebay.co.uk/sch/i.html?_from=R40&_trksid=p2380057.m570.l1313&_sacat=0&_nkw=" + tool.encodeURIComponent_GBK(bookName)
        },
        getBookList: ($, url) => {
            let list = [];
